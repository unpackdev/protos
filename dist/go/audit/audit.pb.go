...
var file_audit_audit_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61,
	...
	0x18, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x75, 0x64, 0x69,
	...
	0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x75, 0x64,
	...
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76,
	...
	0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e,
	...
	0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x75, 0x6e,
	0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2e, 0x45, 0x6c,
...
var file_audit_audit_proto_goTypes = []interface{}{
	(*Report)(nil),             // 0: unpack.v1.audit.Report
	(*Results)(nil),            // 1: unpack.v1.audit.Results
	(*Detector)(nil),           // 2: unpack.v1.audit.Detector
	(*Element)(nil),            // 3: unpack.v1.audit.Element
	(*SourceMapping)(nil),      // 4: unpack.v1.audit.SourceMapping
	(*TypeSpecificFields)(nil), // 5: unpack.v1.audit.TypeSpecificFields
	(*AdditionalFields)(nil),   // 6: unpack.v1.audit.AdditionalFields
}
var file_audit_audit_proto_depIdxs = []int32{
	1, // 0: unpack.v1.audit.Report.results:type_name -> unpack.v1.audit.Results
	2, // 1: unpack.v1.audit.Results.detectors:type_name -> unpack.v1.audit.Detector
	3, // 2: unpack.v1.audit.Detector.elements:type_name -> unpack.v1.audit.Element
	4, // 3: unpack.v1.audit.Element.source_mapping:type_name -> unpack.v1.audit.SourceMapping
	5, // 4: unpack.v1.audit.Element.type_specific_fields:type_name -> unpack.v1.audit.TypeSpecificFields
	6, // 5: unpack.v1.audit.Element.additional_fields:type_name -> unpack.v1.audit.AdditionalFields
	3, // 6: unpack.v1.audit.TypeSpecificFields.parent:type_name -> unpack.v1.audit.Element
