...
var file_eip_discovery_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63,
	0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x65, 0x69, 0x70, 0x2e, 0x53, 0x74, 0x61, 0x6e, 0x64, 0x61, 0x72,
	...
	0x1e, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x65, 0x69, 0x70, 0x2e,
	...
	0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x75, 0x6e,
	0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x65, 0x69, 0x70, 0x2e, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x32, 0x17, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x65, 0x69, 0x70,
...
var file_eip_discovery_proto_goTypes = []interface{}{
	(ConfidenceLevel)(0),     // 0: unpack.v1.eip.ConfidenceLevel
	(ConfidenceThreshold)(0), // 1: unpack.v1.eip.ConfidenceThreshold
	(*Discovery)(nil),        // 2: unpack.v1.eip.Discovery
	(Standard)(0),            // 3: unpack.v1.eip.Standard
	(*Contract)(nil),         // 4: unpack.v1.eip.Contract
}
var file_eip_discovery_proto_depIdxs = []int32{
	3, // 0: unpack.v1.eip.Discovery.standard:type_name -> unpack.v1.eip.Standard
	0, // 1: unpack.v1.eip.Discovery.confidence:type_name -> unpack.v1.eip.ConfidenceLevel
	1, // 2: unpack.v1.eip.Discovery.threshold:type_name -> unpack.v1.eip.ConfidenceThreshold
	4, // 3: unpack.v1.eip.Discovery.contract:type_name -> unpack.v1.eip.Contract
