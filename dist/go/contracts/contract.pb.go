...
import (
	ir "github.com/txpull/protos/dist/go/ir"
...
type Contract struct {
	...
	Optimized         bool   `protobuf:"varint,14,opt,name=optimized,proto3" json:"optimized,omitempty"`                                        // Indicates if the contract is optimized.
	OptimizationRuns  int32  `protobuf:"varint,15,opt,name=optimization_runs,json=optimizationRuns,proto3" json:"optimization_runs,omitempty"`  // Number of optimization runs.
	// List of possible contract types associated.
	PossibleContractTypes []string `protobuf:"bytes,16,rep,name=possible_contract_types,json=possibleContractTypes,proto3" json:"possible_contract_types,omitempty"`
	// Total number of contracts discovered in the IR.
	ContractsCount int32 `protobuf:"varint,17,opt,name=contracts_count,json=contractsCount,proto3" json:"contracts_count,omitempty"`
	// List of Ethereum Improvement Proposals (EIPs) associated with this IR.
	Eips []*ir.EIP `protobuf:"bytes,18,rep,name=eips,proto3" json:"eips,omitempty"`
	// Metadata URLs associated with the contract.
	MetadataUrls []string `protobuf:"bytes,19,rep,name=metadata_urls,json=metadataUrls,proto3" json:"metadata_urls,omitempty"`
	// Implementations associated with the contract.
	Implements []*Implements `protobuf:"bytes,20,rep,name=implements,proto3" json:"implements,omitempty"`
	...
	HasVulnerabilities bool `protobuf:"varint,22,opt,name=has_vulnerabilities,json=hasVulnerabilities,proto3" json:"has_vulnerabilities,omitempty"`
	// Metrics of vulnerabilities associated with the contract.
	VulnerabilityMetrics []*VulnerabilityMetric `protobuf:"bytes,23,rep,name=vulnerability_metrics,json=vulnerabilityMetrics,proto3" json:"vulnerability_metrics,omitempty"`
	// Vulnerabilities associated with the contract.
	Vulnerabilities []*Vulnerability `protobuf:"bytes,24,rep,name=vulnerabilities,proto3" json:"vulnerabilities,omitempty"`
	// ABI of the contract in raw JSON format.
	Abi string `protobuf:"bytes,25,opt,name=abi,proto3" json:"abi,omitempty"`
}
...
func (x *Contract) GetEips() []*ir.EIP {
	if x != nil {
		return x.Eips
	}
	return nil
...
var file_contracts_contract_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x13, 0x74, 0x78, 0x70, 0x75,
	0x6c, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73, 0x1a,
	...
	0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9e, 0x08, 0x0a, 0x08, 0x43, 0x6f,
	...
	,
	...
	0x73, 0x18, 0x16, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x68, 0x61, 0x73, 0x56, 0x75, 0x6c, 0x6e,
	...
	0x72, 0x69, 0x63, 0x73, 0x18, 0x17, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x74, 0x78, 0x70,
	0x75, 0x6c, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73,
	...
	0x6c, 0x6e, 0x65, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18, 0x18, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x74, 0x78, 0x70, 0x75, 0x6c, 0x6c, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x19, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x62, 0x69, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69,
...
var file_contracts_contract_proto_goTypes = []interface{}{
	(*Contract)(nil),            // 0: txpull.v1.contracts.Contract
	(*ir.EIP)(nil),              // 1: txpull.v1.ir.EIP
	(*Implements)(nil),          // 2: txpull.v1.contracts.Implements
	(*Constructor)(nil),         // 3: txpull.v1.contracts.Constructor
	(*VulnerabilityMetric)(nil), // 4: txpull.v1.contracts.VulnerabilityMetric
	(*Vulnerability)(nil),       // 5: txpull.v1.contracts.Vulnerability
}
var file_contracts_contract_proto_depIdxs = []int32{
	1, // 0: txpull.v1.contracts.Contract.eips:type_name -> txpull.v1.ir.EIP
	2, // 1: txpull.v1.contracts.Contract.implements:type_name -> txpull.v1.contracts.Implements
	3, // 2: txpull.v1.contracts.Contract.constructor:type_name -> txpull.v1.contracts.Constructor
	4, // 3: txpull.v1.contracts.Contract.vulnerability_metrics:type_name -> txpull.v1.contracts.VulnerabilityMetric
	5, // 4: txpull.v1.contracts.Contract.vulnerabilities:type_name -> txpull.v1.contracts.Vulnerability
