...
var file_abi_root_proto_rawDesc = []byte{
	...
	0x12, 0x0d, 0x74, 0x78, 0x70, 0x75, 0x6c, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x62, 0x69, 0x1a,
	...
	0x22, 0x2e, 0x74, 0x78, 0x70, 0x75, 0x6c, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x62, 0x69, 0x2e,
...
var file_abi_root_proto_goTypes = []interface{}{
	(*Root)(nil),     // 0: txpull.v1.abi.Root
	nil,              // 1: txpull.v1.abi.Root.ContractsEntry
	(*Contract)(nil), // 2: txpull.v1.abi.Contract
}
var file_abi_root_proto_depIdxs = []int32{
	1, // 0: txpull.v1.abi.Root.contracts:type_name -> txpull.v1.abi.Root.ContractsEntry
	2, // 1: txpull.v1.abi.Root.ContractsEntry.value:type_name -> txpull.v1.abi.Contract
