...
var file_ast_for_proto_rawDesc = []byte{
	...
	0x64, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63,
	0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x42, 0x6f, 0x64, 0x79, 0x52, 0x04, 0x62,
...
var file_ast_for_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.For.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.For.src:type_name -> unpack.v1.ast.Src
	3, // 2: unpack.v1.ast.For.initialiser:type_name -> xds.type.v3.TypedStruct
	3, // 3: unpack.v1.ast.For.condition:type_name -> xds.type.v3.TypedStruct
	3, // 4: unpack.v1.ast.For.closure:type_name -> xds.type.v3.TypedStruct
	4, // 5: unpack.v1.ast.For.body:type_name -> unpack.v1.ast.Body
