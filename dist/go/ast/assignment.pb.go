...
type Assignment struct {
	...
	Operator              Operator         `protobuf:"varint,5,opt,name=operator,proto3,enum=unpack.v1.ast.Operator" json:"operator,omitempty"`
...
var file_ast_assignment_proto_goTypes = []interface{}{
	(*Assignment)(nil),      // 0: unpack.v1.ast.Assignment
...
var file_ast_assignment_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Assignment.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Assignment.src:type_name -> unpack.v1.ast.Src
	3, // 2: unpack.v1.ast.Assignment.expression:type_name -> xds.type.v3.TypedStruct
	4, // 3: unpack.v1.ast.Assignment.operator:type_name -> unpack.v1.ast.Operator
	3, // 4: unpack.v1.ast.Assignment.left_expression:type_name -> xds.type.v3.TypedStruct
	3, // 5: unpack.v1.ast.Assignment.right_expression:type_name -> xds.type.v3.TypedStruct
	5, // 6: unpack.v1.ast.Assignment.type_description:type_name -> unpack.v1.ast.TypeDescription
