...
var file_ast_tuple_proto_goTypes = []interface{}{
	(*Tuple)(nil),           // 0: unpack.v1.ast.Tuple
...
var file_ast_tuple_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Tuple.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Tuple.src:type_name -> unpack.v1.ast.Src
	3, // 2: unpack.v1.ast.Tuple.components:type_name -> xds.type.v3.TypedStruct
	4, // 3: unpack.v1.ast.Tuple.type_description:type_name -> unpack.v1.ast.TypeDescription
