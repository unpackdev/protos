...
const (
	Service_Get_FullMethodName       = "/unpack.v1.ast.Service/Get"
	Service_Decompile_FullMethodName = "/unpack.v1.ast.Service/Decompile"
)
...
func (c *serviceClient) Decompile(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, Service_Decompile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Decompile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).Decompile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_Decompile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
