...
var file_ast_return_proto_goTypes = []interface{}{
	(*Return)(nil),          // 0: txpull.v1.ast.Return
...
var file_ast_return_proto_depIdxs = []int32{
	1, // 0: txpull.v1.ast.Return.node_type:type_name -> txpull.v1.ast.NodeType
	2, // 1: txpull.v1.ast.Return.src:type_name -> txpull.v1.ast.Src
	3, // 2: txpull.v1.ast.Return.expression:type_name -> xds.type.v3.TypedStruct
	4, // 3: txpull.v1.ast.Return.type_description:type_name -> txpull.v1.ast.TypeDescription
