...
var file_ast_conditional_proto_rawDesc = []byte{
	...
	0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e,
...
var file_ast_conditional_proto_goTypes = []interface{}{
	(*Conditional)(nil),     // 0: unpack.v1.ast.Conditional
...
var file_ast_conditional_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Conditional.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Conditional.src:type_name -> unpack.v1.ast.Src
	3, // 2: unpack.v1.ast.Conditional.expressions:type_name -> xds.type.v3.TypedStruct
	4, // 3: unpack.v1.ast.Conditional.type_descriptions:type_name -> unpack.v1.ast.TypeDescription
