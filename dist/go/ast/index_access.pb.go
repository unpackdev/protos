...
var file_ast_index_access_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x6e,
...
var file_ast_index_access_proto_goTypes = []interface{}{
	(*IndexAccess)(nil),     // 0: unpack.v1.ast.IndexAccess
...
var file_ast_index_access_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.IndexAccess.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.IndexAccess.src:type_name -> unpack.v1.ast.Src
	3, // 2: unpack.v1.ast.IndexAccess.index_expression:type_name -> xds.type.v3.TypedStruct
	3, // 3: unpack.v1.ast.IndexAccess.base_expression:type_name -> xds.type.v3.TypedStruct
	4, // 4: unpack.v1.ast.IndexAccess.type_descriptions:type_name -> unpack.v1.ast.TypeDescription
	4, // 5: unpack.v1.ast.IndexAccess.type_description:type_name -> unpack.v1.ast.TypeDescription
