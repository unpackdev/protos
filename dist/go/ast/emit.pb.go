...
var file_ast_emit_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Emit.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Emit.src:type_name -> unpack.v1.ast.Src
	3, // 2: unpack.v1.ast.Emit.arguments:type_name -> xds.type.v3.TypedStruct
	3, // 3: unpack.v1.ast.Emit.expression:type_name -> xds.type.v3.TypedStruct
