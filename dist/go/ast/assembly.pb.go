...
var file_ast_assembly_proto_goTypes = []interface{}{
	(*Assembly)(nil), // 0: unpack.v1.ast.Assembly
	(NodeType)(0),    // 1: unpack.v1.ast.NodeType
	(*Src)(nil),      // 2: unpack.v1.ast.Src
}
var file_ast_assembly_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Assembly.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Assembly.src:type_name -> unpack.v1.ast.Src
