...
var file_ast_break_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x73, 0x72, 0x63, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_ast_break_proto_goTypes = []interface{}{
	(*Break)(nil), // 0: unpack.v1.ast.Break
	(NodeType)(0), // 1: unpack.v1.ast.NodeType
	(*Src)(nil),   // 2: unpack.v1.ast.Src
}
var file_ast_break_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Break.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Break.src:type_name -> unpack.v1.ast.Src
