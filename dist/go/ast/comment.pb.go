...
var file_ast_comment_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x42, 0x30,
...
var file_ast_comment_proto_goTypes = []interface{}{
	(*Comment)(nil), // 0: unpack.v1.ast.Comment
	(NodeType)(0),   // 1: unpack.v1.ast.NodeType
	(*Src)(nil),     // 2: unpack.v1.ast.Src
}
var file_ast_comment_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Comment.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Comment.src:type_name -> unpack.v1.ast.Src
