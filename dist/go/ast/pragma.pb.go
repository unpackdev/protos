...
var file_ast_pragma_proto_goTypes = []interface{}{
	(*Pragma)(nil), // 0: txpull.v1.ast.Pragma
	(NodeType)(0),  // 1: txpull.v1.ast.NodeType
	(*Src)(nil),    // 2: txpull.v1.ast.Src
}
var file_ast_pragma_proto_depIdxs = []int32{
	1, // 0: txpull.v1.ast.Pragma.node_type:type_name -> txpull.v1.ast.NodeType
	2, // 1: txpull.v1.ast.Pragma.src:type_name -> txpull.v1.ast.Src
