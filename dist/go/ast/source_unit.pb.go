...
var file_ast_source_unit_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31,
	...
	0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x43,
	...
	0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x75,
	...
	0x24, 0x0a, 0x03, 0x73, 0x72, 0x63, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x75,
	...
	0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b,
...
var file_ast_source_unit_proto_goTypes = []interface{}{
	...
	(*Comment)(nil),        // 4: unpack.v1.ast.Comment
	(*RootNode)(nil),       // 5: unpack.v1.ast.RootNode
	(*Src)(nil),            // 6: unpack.v1.ast.Src
}
var file_ast_source_unit_proto_depIdxs = []int32{
	3, // 0: unpack.v1.ast.RootSourceUnit.node_type:type_name -> unpack.v1.ast.NodeType
	1, // 1: unpack.v1.ast.RootSourceUnit.source_units:type_name -> unpack.v1.ast.SourceUnit
	4, // 2: unpack.v1.ast.RootSourceUnit.comments:type_name -> unpack.v1.ast.Comment
	2, // 3: unpack.v1.ast.SourceUnit.exported_symbols:type_name -> unpack.v1.ast.ExportedSymbol
	3, // 4: unpack.v1.ast.SourceUnit.node_type:type_name -> unpack.v1.ast.NodeType
	5, // 5: unpack.v1.ast.SourceUnit.root:type_name -> unpack.v1.ast.RootNode
	6, // 6: unpack.v1.ast.SourceUnit.src:type_name -> unpack.v1.ast.Src
	4, // 7: unpack.v1.ast.SourceUnit.comments:type_name -> unpack.v1.ast.Comment
