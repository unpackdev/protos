...
type SourceUnit struct {
	...
	ExportedSymbols []*ExportedSymbols `protobuf:"bytes,4,rep,name=exported_symbols,json=exportedSymbols,proto3" json:"exported_symbols,omitempty"`
	...
	Nodes           *RootNode          `protobuf:"bytes,6,opt,name=nodes,proto3" json:"nodes,omitempty"`
...
func (x *SourceUnit) GetExportedSymbols() []*ExportedSymbols {
	if x != nil {
...
func (x *SourceUnit) GetNodes() *RootNode {
	if x != nil {
		return x.Nodes
	}
	return nil
...
func (x *ExportedSymbols) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExportedSymbols) ProtoMessage() {}

func (x *ExportedSymbols) ProtoReflect() protoreflect.Message {
	mi := &file_ast_source_unit_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExportedSymbols.ProtoReflect.Descriptor instead.
func (*ExportedSymbols) Descriptor() ([]byte, []int) {
	return file_ast_source_unit_proto_rawDescGZIP(), []int{2}
}

func (x *ExportedSymbols) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ExportedSymbols) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_ast_source_unit_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x63, 0x65, 0x55, 0x6e, 0x69, 0x74, 0x73, 0x22, 0xe5, 0x02, 0x0a, 0x0a, 0x53, 0x6f,
	...
	0x75, 0x74, 0x65, 0x50, 0x61, 0x74, 0x68, 0x12, 0x49, 0x0a, 0x10, 0x65, 0x78, 0x70, 0x6f, 0x72,
	...
	,
...
var file_ast_source_unit_proto_goTypes = []interface{}{
	...
	(*ExportedSymbols)(nil), // 2: txpull.v1.ast.ExportedSymbols
...
var file_ast_source_unit_proto_depIdxs = []int32{
	...
	2, // 1: txpull.v1.ast.SourceUnit.exported_symbols:type_name -> txpull.v1.ast.ExportedSymbols
	3, // 2: txpull.v1.ast.SourceUnit.node_type:type_name -> txpull.v1.ast.NodeType
	4, // 3: txpull.v1.ast.SourceUnit.nodes:type_name -> txpull.v1.ast.RootNode
