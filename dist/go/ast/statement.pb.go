...
type Statement struct {
	...
	Kind                     NodeType         `protobuf:"varint,9,opt,name=kind,proto3,enum=unpack.v1.ast.NodeType" json:"kind,omitempty"`
...
type Expression struct {
	...
	Operator                 Operator           `protobuf:"varint,11,opt,name=operator,proto3,enum=unpack.v1.ast.Operator" json:"operator,omitempty"`
	...
	Kind                     NodeType           `protobuf:"varint,14,opt,name=kind,proto3,enum=unpack.v1.ast.NodeType" json:"kind,omitempty"`
...
var file_ast_statement_proto_rawDesc = []byte{
	...
	0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x45,
	...
	0x6f, 0x6e, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x75, 0x6e, 0x70, 0x61,
	0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x44, 0x65, 0x63, 0x6c, 0x61, 0x72,
	...
	0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75,
	0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x45, 0x78, 0x70,
	...
	0x11, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76,
	...
	0x79, 0x18, 0x13, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b,
	...
	0x18, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e,
	...
	0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76,
	0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x45, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x74, 0x73, 0x18, 0x15, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63,
	0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x45, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73,
	...
	0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e,
	0x61, 0x73, 0x74, 0x2e, 0x45, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x0a,
	...
	0x18, 0x1a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e,
...
var file_ast_statement_proto_goTypes = []interface{}{
	(*Statement)(nil),       // 0: unpack.v1.ast.Statement
	(*Expression)(nil),      // 1: unpack.v1.ast.Expression
	(NodeType)(0),           // 2: unpack.v1.ast.NodeType
	(*Src)(nil),             // 3: unpack.v1.ast.Src
	(*Declaration)(nil),     // 4: unpack.v1.ast.Declaration
	(*TypeDescription)(nil), // 5: unpack.v1.ast.TypeDescription
	(Operator)(0),           // 6: unpack.v1.ast.Operator
}
var file_ast_statement_proto_depIdxs = []int32{
	2,  // 0: unpack.v1.ast.Statement.node_type:type_name -> unpack.v1.ast.NodeType
	3,  // 1: unpack.v1.ast.Statement.src:type_name -> unpack.v1.ast.Src
	1,  // 2: unpack.v1.ast.Statement.expression:type_name -> unpack.v1.ast.Expression
	4,  // 3: unpack.v1.ast.Statement.declarations:type_name -> unpack.v1.ast.Declaration
	1,  // 4: unpack.v1.ast.Statement.initial_value:type_name -> unpack.v1.ast.Expression
	2,  // 5: unpack.v1.ast.Statement.kind:type_name -> unpack.v1.ast.NodeType
	5,  // 6: unpack.v1.ast.Statement.type_description:type_name -> unpack.v1.ast.TypeDescription
	1,  // 7: unpack.v1.ast.Statement.arguments:type_name -> unpack.v1.ast.Expression
	1,  // 8: unpack.v1.ast.Statement.condition:type_name -> unpack.v1.ast.Expression
	0,  // 9: unpack.v1.ast.Statement.true_body:type_name -> unpack.v1.ast.Statement
	0,  // 10: unpack.v1.ast.Statement.statements:type_name -> unpack.v1.ast.Statement
	2,  // 11: unpack.v1.ast.Expression.node_type:type_name -> unpack.v1.ast.NodeType
	3,  // 12: unpack.v1.ast.Expression.src:type_name -> unpack.v1.ast.Src
	5,  // 13: unpack.v1.ast.Expression.type_description:type_name -> unpack.v1.ast.TypeDescription
	1,  // 14: unpack.v1.ast.Expression.expression:type_name -> unpack.v1.ast.Expression
	5,  // 15: unpack.v1.ast.Expression.common_type:type_name -> unpack.v1.ast.TypeDescription
	5,  // 16: unpack.v1.ast.Expression.argument_types:type_name -> unpack.v1.ast.TypeDescription
	6,  // 17: unpack.v1.ast.Expression.operator:type_name -> unpack.v1.ast.Operator
	1,  // 18: unpack.v1.ast.Expression.left_expression:type_name -> unpack.v1.ast.Expression
	1,  // 19: unpack.v1.ast.Expression.right_expression:type_name -> unpack.v1.ast.Expression
	2,  // 20: unpack.v1.ast.Expression.kind:type_name -> unpack.v1.ast.NodeType
	1,  // 21: unpack.v1.ast.Expression.arguments:type_name -> unpack.v1.ast.Expression
	1,  // 22: unpack.v1.ast.Expression.components:type_name -> unpack.v1.ast.Expression
	1,  // 23: unpack.v1.ast.Expression.base_expression:type_name -> unpack.v1.ast.Expression
	1,  // 24: unpack.v1.ast.Expression.index_expression:type_name -> unpack.v1.ast.Expression
