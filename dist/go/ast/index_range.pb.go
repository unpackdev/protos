...
var file_ast_index_range_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e,
	...
	0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63,
...
var file_ast_index_range_proto_goTypes = []interface{}{
	(*IndexRange)(nil),      // 0: unpack.v1.ast.IndexRange
...
var file_ast_index_range_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.IndexRange.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.IndexRange.src:type_name -> unpack.v1.ast.Src
	3, // 2: unpack.v1.ast.IndexRange.left_expression:type_name -> xds.type.v3.TypedStruct
	3, // 3: unpack.v1.ast.IndexRange.right_expression:type_name -> xds.type.v3.TypedStruct
	4, // 4: unpack.v1.ast.IndexRange.type_description:type_name -> unpack.v1.ast.TypeDescription
