...
var file_ast_continue_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x2e, 0x53, 0x72, 0x63, 0x52, 0x03, 0x73, 0x72, 0x63, 0x42, 0x30, 0x5a, 0x2e, 0x67,
...
var file_ast_continue_proto_goTypes = []interface{}{
	(*Continue)(nil), // 0: unpack.v1.ast.Continue
	(NodeType)(0),    // 1: unpack.v1.ast.NodeType
	(*Src)(nil),      // 2: unpack.v1.ast.Src
}
var file_ast_continue_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Continue.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Continue.src:type_name -> unpack.v1.ast.Src
