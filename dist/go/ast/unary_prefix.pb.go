...
type UnaryPrefixOperator struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *UnaryPrefixOperator) Reset() {
	*x = UnaryPrefixOperator{}
...
func (x *UnaryPrefixOperator) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnaryPrefixOperator) ProtoMessage() {}

func (x *UnaryPrefixOperator) ProtoReflect() protoreflect.Message {
	mi := &file_ast_unary_prefix_proto_msgTypes[0]
...
// Deprecated: Use UnaryPrefixOperator.ProtoReflect.Descriptor instead.
func (*UnaryPrefixOperator) Descriptor() ([]byte, []int) {
...
var file_ast_unary_prefix_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x42, 0x2d,
...
var file_ast_unary_prefix_proto_goTypes = []interface{}{
	(*UnaryPrefixOperator)(nil), // 0: txpull.v1.ast.UnaryPrefixOperator
}
...
func file_ast_unary_prefix_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ast_unary_prefix_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UnaryPrefixOperator); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
