...
var file_ast_unary_prefix_proto_depIdxs = []int32{
	...
	2, // 1: unpack.v1.ast.UnaryPrefix.src:type_name -> unpack.v1.ast.Src
	3, // 2: unpack.v1.ast.UnaryPrefix.operator:type_name -> unpack.v1.ast.Operator
	4, // 3: unpack.v1.ast.UnaryPrefix.expression:type_name -> xds.type.v3.TypedStruct
	5, // 4: unpack.v1.ast.UnaryPrefix.type_description:type_name -> unpack.v1.ast.TypeDescription
