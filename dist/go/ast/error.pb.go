...
func (x *Error) Reset() {
	*x = Error{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ast_error_proto_msgTypes[0]
...
func (*Error) Descriptor() ([]byte, []int) {
	return file_ast_error_proto_rawDescGZIP(), []int{0}
}
...
var file_ast_error_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x61, 0x73, 0x74, 0x2f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x65, 0x74, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc9, 0x02, 0x0a, 0x05,
	...
	0x52, 0x03, 0x73, 0x72, 0x63, 0x12, 0x37, 0x0a, 0x0d, 0x6e, 0x61, 0x6d, 0x65, 0x5f, 0x6c, 0x6f,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x75,
	0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x53, 0x72, 0x63,
	0x52, 0x0c, 0x6e, 0x61, 0x6d, 0x65, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3c,
	...
	0x52, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x49, 0x0a, 0x10,
...
var (
	file_ast_error_proto_rawDescOnce sync.Once
	file_ast_error_proto_rawDescData = file_ast_error_proto_rawDesc
)

func file_ast_error_proto_rawDescGZIP() []byte {
	file_ast_error_proto_rawDescOnce.Do(func() {
		file_ast_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_ast_error_proto_rawDescData)
	})
	return file_ast_error_proto_rawDescData
}

var file_ast_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ast_error_proto_goTypes = []interface{}{
	(*Error)(nil),           // 0: unpack.v1.ast.Error
...
var file_ast_error_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Error.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ast.Error.src:type_name -> unpack.v1.ast.Src
	2, // 2: unpack.v1.ast.Error.name_location:type_name -> unpack.v1.ast.Src
	3, // 3: unpack.v1.ast.Error.parameters:type_name -> unpack.v1.ast.ParameterList
	4, // 4: unpack.v1.ast.Error.type_description:type_name -> unpack.v1.ast.TypeDescription
...
func init() { file_ast_error_proto_init() }
func file_ast_error_proto_init() {
	if File_ast_error_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_ast_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Error); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ast_error_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ast_error_proto_goTypes,
		DependencyIndexes: file_ast_error_proto_depIdxs,
		MessageInfos:      file_ast_error_proto_msgTypes,
	}.Build()
	File_ast_error_proto = out.File
	file_ast_error_proto_rawDesc = nil
	file_ast_error_proto_goTypes = nil
	file_ast_error_proto_depIdxs = nil
}
