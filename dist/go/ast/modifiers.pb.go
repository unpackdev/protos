...
type Modifier struct {
	...
	ArgumentTypes         []*TypeDescriptions `protobuf:"bytes,7,rep,name=argument_types,json=argumentTypes,proto3" json:"argument_types,omitempty"`
...
func (x *Modifier) GetReferencedDeclaration() int64 {
	if x != nil {
		return x.ReferencedDeclaration
	}
	return 0
...
func (x *Modifier) GetArguments() []*Expression {
	if x != nil {
		return x.Arguments
	}
	return nil
...
func (x *Modifier) GetArgumentTypes() []*TypeDescriptions {
	if x != nil {
...
func (x *Modifier) GetModifierName() *ModifierName {
	if x != nil {
...
var file_ast_modifiers_proto_rawDesc = []byte{
	...
	0x72, 0x63, 0x52, 0x03, 0x73, 0x72, 0x63, 0x22, 0x84, 0x03, 0x0a, 0x08, 0x4d, 0x6f, 0x64, 0x69,
	...
	,
	...
	0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74, 0x78, 0x70, 0x75, 0x6c, 0x6c, 0x2e, 0x76, 0x31, 0x2e,
	0x61, 0x73, 0x74, 0x2e, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65,
	0x52, 0x0c, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x2d,
...
var file_ast_modifiers_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_ast_modifiers_proto_goTypes = []interface{}{
	...
	(*Expression)(nil),       // 4: txpull.v1.ast.Expression
	(*TypeDescriptions)(nil), // 5: txpull.v1.ast.TypeDescriptions
}
var file_ast_modifiers_proto_depIdxs = []int32{
	2, // 0: txpull.v1.ast.ModifierName.node_type:type_name -> txpull.v1.ast.NodeType
	3, // 1: txpull.v1.ast.ModifierName.src:type_name -> txpull.v1.ast.Src
	2, // 2: txpull.v1.ast.Modifier.node_type:type_name -> txpull.v1.ast.NodeType
	3, // 3: txpull.v1.ast.Modifier.src:type_name -> txpull.v1.ast.Src
	4, // 4: txpull.v1.ast.Modifier.arguments:type_name -> txpull.v1.ast.Expression
	5, // 5: txpull.v1.ast.Modifier.argument_types:type_name -> txpull.v1.ast.TypeDescriptions
	0, // 6: txpull.v1.ast.Modifier.modifier_name:type_name -> txpull.v1.ast.ModifierName
