...
var file_ast_body_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ast.Body.node_type:type_name -> unpack.v1.ast.NodeType
	1, // 1: unpack.v1.ast.Body.kind:type_name -> unpack.v1.ast.NodeType
	2, // 2: unpack.v1.ast.Body.src:type_name -> unpack.v1.ast.Src
	3, // 3: unpack.v1.ast.Body.statements:type_name -> xds.type.v3.TypedStruct
