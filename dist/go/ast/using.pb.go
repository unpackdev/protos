...
func (x *UsingDirective) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UsingDirective) ProtoMessage() {}

func (x *UsingDirective) ProtoReflect() protoreflect.Message {
	mi := &file_ast_using_proto_msgTypes[0]
...
// Deprecated: Use UsingDirective.ProtoReflect.Descriptor instead.
func (*UsingDirective) Descriptor() ([]byte, []int) {
...
var file_ast_using_proto_rawDesc = []byte{
	...
	0x22, 0x10, 0x0a, 0x0e, 0x55, 0x73, 0x69, 0x6e, 0x67, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69,
...
var file_ast_using_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ast_using_proto_goTypes = []interface{}{
	(*UsingDirective)(nil), // 0: txpull.v1.ast.UsingDirective
}
