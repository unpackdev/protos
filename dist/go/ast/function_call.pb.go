...
func (x *FunctionCallOption) Reset() {
	*x = FunctionCallOption{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ast_function_call_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FunctionCallOption) Descriptor() ([]byte, []int) {
	return file_ast_function_call_proto_rawDescGZIP(), []int{1}
}
...
var file_ast_function_call_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x75, 0x6e, 0x70, 0x61, 0x63,
	...
	0x6f, 0x6e, 0x22, 0xe9, 0x02, 0x0a, 0x12, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43,
	0x61, 0x6c, 0x6c, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x52, 0x0a, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x16,
...
var file_ast_function_call_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_ast_function_call_proto_goTypes = []interface{}{
	(*FunctionCall)(nil),       // 0: unpack.v1.ast.FunctionCall
	(*FunctionCallOption)(nil), // 1: unpack.v1.ast.FunctionCallOption
...
var file_ast_function_call_proto_depIdxs = []int32{
	2,  // 0: unpack.v1.ast.FunctionCall.node_type:type_name -> unpack.v1.ast.NodeType
	2,  // 1: unpack.v1.ast.FunctionCall.kind:type_name -> unpack.v1.ast.NodeType
	3,  // 2: unpack.v1.ast.FunctionCall.src:type_name -> unpack.v1.ast.Src
	4,  // 3: unpack.v1.ast.FunctionCall.argument_types:type_name -> unpack.v1.ast.TypeDescription
	5,  // 4: unpack.v1.ast.FunctionCall.arguments:type_name -> xds.type.v3.TypedStruct
	5,  // 5: unpack.v1.ast.FunctionCall.expression:type_name -> xds.type.v3.TypedStruct
	4,  // 6: unpack.v1.ast.FunctionCall.type_description:type_name -> unpack.v1.ast.TypeDescription
	2,  // 7: unpack.v1.ast.FunctionCallOption.node_type:type_name -> unpack.v1.ast.NodeType
	2,  // 8: unpack.v1.ast.FunctionCallOption.kind:type_name -> unpack.v1.ast.NodeType
	3,  // 9: unpack.v1.ast.FunctionCallOption.src:type_name -> unpack.v1.ast.Src
	5,  // 10: unpack.v1.ast.FunctionCallOption.expression:type_name -> xds.type.v3.TypedStruct
	4,  // 11: unpack.v1.ast.FunctionCallOption.type_description:type_name -> unpack.v1.ast.TypeDescription
...
func file_ast_function_call_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ast_function_call_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FunctionCallOption); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
