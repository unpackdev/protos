...
var file_ir_constructor_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76,
	...
	0x69, 0x74, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70, 0x61,
	...
	0x6c, 0x69, 0x74, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x75, 0x6e, 0x70,
	...
	0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x74, 0x65, 0x72, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x75, 0x6e, 0x70,
	0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x69, 0x72, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65,
	...
	0x17, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x69, 0x72, 0x2e, 0x50,
...
var file_ir_constructor_proto_goTypes = []interface{}{
	(*Constructor)(nil), // 0: unpack.v1.ir.Constructor
	...
	(*Parameter)(nil),   // 5: unpack.v1.ir.Parameter
}
var file_ir_constructor_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ir.Constructor.node_type:type_name -> unpack.v1.ast.NodeType
	1, // 1: unpack.v1.ir.Constructor.kind:type_name -> unpack.v1.ast.NodeType
	2, // 2: unpack.v1.ir.Constructor.visibility:type_name -> unpack.v1.ast.Visibility
	3, // 3: unpack.v1.ir.Constructor.state_mutability:type_name -> unpack.v1.ast.Mutability
	4, // 4: unpack.v1.ir.Constructor.modifiers:type_name -> unpack.v1.ir.Modifier
	5, // 5: unpack.v1.ir.Constructor.parameters:type_name -> unpack.v1.ir.Parameter
	5, // 6: unpack.v1.ir.Constructor.return:type_name -> unpack.v1.ir.Parameter
