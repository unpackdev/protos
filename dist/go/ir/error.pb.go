...
var file_ir_error_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76,
	...
	0x32, 0x17, 0x2e, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x69, 0x72, 0x2e,
...
var file_ir_error_proto_goTypes = []interface{}{
	(*Error)(nil),               // 0: unpack.v1.ir.Error
...
var file_ir_error_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ir.Error.node_type:type_name -> unpack.v1.ast.NodeType
	2, // 1: unpack.v1.ir.Error.parameters:type_name -> unpack.v1.ir.Parameter
	3, // 2: unpack.v1.ir.Error.type_description:type_name -> unpack.v1.ast.TypeDescription
