...
var file_ir_function_call_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x75, 0x6e, 0x70, 0x61,
	0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x61, 0x73, 0x74, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x44, 0x65,
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0f, 0x74, 0x79, 0x70, 0x65, 0x44,
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69,
...
var file_ir_function_call_proto_goTypes = []interface{}{
	(*FunctionCall)(nil),        // 0: unpack.v1.ir.FunctionCall
	(ast.NodeType)(0),           // 1: unpack.v1.ast.NodeType
	(*ast.TypeDescription)(nil), // 2: unpack.v1.ast.TypeDescription
	(*Argument)(nil),            // 3: unpack.v1.ir.Argument
}
var file_ir_function_call_proto_depIdxs = []int32{
	1, // 0: unpack.v1.ir.FunctionCall.node_type:type_name -> unpack.v1.ast.NodeType
	1, // 1: unpack.v1.ir.FunctionCall.kind:type_name -> unpack.v1.ast.NodeType
	2, // 2: unpack.v1.ir.FunctionCall.argument_types:type_name -> unpack.v1.ast.TypeDescription
	3, // 3: unpack.v1.ir.FunctionCall.arguments:type_name -> unpack.v1.ir.Argument
	2, // 4: unpack.v1.ir.FunctionCall.type_description:type_name -> unpack.v1.ast.TypeDescription
