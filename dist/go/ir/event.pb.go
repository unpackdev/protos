...
type Event struct {
	...
	// List of parameters associated with the event. Each parameter is defined using the "txpull.v1.ir.Parameter" message.
...
var file_ir_event_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x74, 0x78, 0x70, 0x75,
	0x6c, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x69, 0x72, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	0x65, 0x72, 0x52, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x42, 0x2b,
	0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x78, 0x70,
	0x75, 0x6c, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x64, 0x69, 0x73, 0x74, 0x2f,
	0x67, 0x6f, 0x2f, 0x69, 0x72, 0x3b, 0x69, 0x72, 0x5f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_ir_event_proto_goTypes = []interface{}{
	(*Event)(nil),     // 0: txpull.v1.ir.Event
	(ast.NodeType)(0), // 1: txpull.v1.ast.NodeType
	(*Parameter)(nil), // 2: txpull.v1.ir.Parameter
}
var file_ir_event_proto_depIdxs = []int32{
	1, // 0: txpull.v1.ir.Event.node_type:type_name -> txpull.v1.ast.NodeType
	2, // 1: txpull.v1.ir.Event.parameters:type_name -> txpull.v1.ir.Parameter
