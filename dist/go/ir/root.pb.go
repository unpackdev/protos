...
var file_ir_root_proto_rawDesc = []byte{
	...
	0x70, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x74, 0x78, 0x70, 0x75, 0x6c,
	0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x69, 0x72, 0x2e, 0x45, 0x49, 0x50, 0x52, 0x04, 0x65, 0x69, 0x70,
	...
	0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_ir_root_proto_goTypes = []interface{}{
	...
	(*EIP)(nil),       // 2: txpull.v1.ir.EIP
	(*Contract)(nil),  // 3: txpull.v1.ir.Contract
}
var file_ir_root_proto_depIdxs = []int32{
	1, // 0: txpull.v1.ir.Root.node_type:type_name -> txpull.v1.ast.NodeType
	2, // 1: txpull.v1.ir.Root.eips:type_name -> txpull.v1.ir.EIP
	3, // 2: txpull.v1.ir.Root.contracts:type_name -> txpull.v1.ir.Contract
