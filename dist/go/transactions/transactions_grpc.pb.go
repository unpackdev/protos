...
func (c *transactionsClient) Filter(ctx context.Context, in *FilterTransactionRequest, opts ...grpc.CallOption) (*FilterTransactionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/txpull.v1.transaction.Transactions/Filter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionsClient) Get(ctx context.Context, in *GetTransactionRequest, opts ...grpc.CallOption) (*GetTransactionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/txpull.v1.transaction.Transactions/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTransactionsServer) Filter(context.Context, *FilterTransactionRequest) (*FilterTransactionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Filter not implemented")
}
func (UnimplementedTransactionsServer) Get(context.Context, *GetTransactionRequest) (*GetTransactionResponse, error) {
...
func _Transactions_Filter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FilterTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionsServer).Filter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/txpull.v1.transaction.Transactions/Filter",
	}
...
func _Transactions_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionsServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/txpull.v1.transaction.Transactions/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Transactions_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "txpull.v1.transaction.Transactions",
