 ...
 * @const
 */
proto.txpull.v1.unpack.Contract.repeatedFields_ = [21];
...
proto.txpull.v1.unpack.Contract.prototype.getSourcesList = function() {
  return /** @type{!Array<!proto.txpull.v1.unpack.Source>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.txpull.v1.unpack.Source, 21));
};
...
proto.txpull.v1.unpack.Contract.prototype.addSources = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 21, opt_value, proto.txpull.v1.unpack.Source, opt_index);
};
