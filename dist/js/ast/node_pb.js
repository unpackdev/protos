 ...
 * @const
 */
proto.txpull.v1.ast.Node.repeatedFields_ = [9,10,11];
...
proto.txpull.v1.ast.Node.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    visibility: jspb.Message.getFieldWithDefault(msg, 12, ""),
    stateMutability: jspb.Message.getFieldWithDefault(msg, 13, ""),
...
/**
 * optional string state_mutability = 13;
 * @return {string}
 */
